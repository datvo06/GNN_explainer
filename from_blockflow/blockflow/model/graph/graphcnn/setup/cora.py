...
def load_cora_dataset():
    ...
    from graphkv.algorithm.architecture.graphcnn import SingleGraphInputPipeline
    ...
    return SingleGraphInputPipeline(vertices = features, adjacency=adj_mat, labels=labels)
